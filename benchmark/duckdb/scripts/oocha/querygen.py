# Most of this script is copied from https://github.com/lnkuiper/experiments/blob/master/oocha/scripts/querygen.py

import os

SCRIPTS_DIR = os.path.dirname(__file__)
BASE_DIR = f"{SCRIPTS_DIR}/../.."
OOCHA_DIR = f"{BASE_DIR}/oocha"
QUERIES_DIR = f"{OOCHA_DIR}/queries"
